...
@Controller
@RequestMapping("/admin/departmentform*")
public class DepartmentFormController extends BaseFormController {
    ...
    public DepartmentFormController() {
        setCancelView("redirect:/admin/departments");
        setSuccessView("redirect:/admin/departments");
    }
    ...
    throws Exception {
        ...
        if (request.getParameter("delete") != null) {
            ...
            if (!isNew) {
                success = "redirect:/admin/departmentform?id=" + department.getId();
            }
        }
